 ...
 */
public class BitVector extends Object implements java.io.Serializable, Cloneable {
	/*
 ...
 * @throws CloneNotSupportedException 
 */
public BitVector copy() throws CloneNotSupportedException {
 ...
 * @throws IndexOutOfBoundsException if <tt>size()&gt;0 && (from&lt;0 || from&gt;to || to&gt;=size()))</tt>.
 */
public BitVector partFromTo(int from, int to) throws CloneNotSupportedException {
 ...
 */
public void replaceFromToWith(int from, int to, BitVector source, int sourceFrom) throws CloneNotSupportedException {
 ...
 * @throws IllegalArgumentException if <tt>size &lt; 0</tt>.
 */
public void setSize(int newSize) throws CloneNotSupportedException {
	if (newSize!=size()) {
